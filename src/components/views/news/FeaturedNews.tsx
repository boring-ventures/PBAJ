            ...
            >
              <CardHeader className="p-0">
                {article.featuredImageUrl ? (
                  ...
                  <div
                    className={`bg-gradient-to-br from-primary/10 to-secondary/10 flex items-center justify-center ${
                      index === 0 && news.length >= 3
                        ? "aspect-[2/1]"
                        : "aspect-[4/3]"
                    }`}
              ...
              <CardContent
                className={`p-6 ${index === 0 && news.length >= 3 ? "lg:p-8" : ""}`}
              >
                ...
                <h3
                  className={`font-semibold text-foreground mb-3 line-clamp-2 group-hover:text-primary transition-colors ${
                    index === 0 && news.length >= 3
                      ? "text-2xl lg:text-3xl lg:mb-4"
                      : "text-lg"
                  }`}
                >
