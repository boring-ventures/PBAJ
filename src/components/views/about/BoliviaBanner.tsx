  ...
  const slides = [
    {
      id: 1,
      backgroundImage:
        "https://images.unsplash.com/photo-1621473078384-a2a6886e1a3b?q=80&w=2074&auto=format&fit=crop",
      icon: Heart,
      emoji: "❤️",
      ...
      stats: [
        {
          number: "25K+",
          label: locale === "es" ? "Vidas Impactadas" : "Lives Impacted",
          emoji: "👥",
        },
        {
          number: "120+",
    ...
    },
    {
      ...
      stats: [
        ...
        {
          number: "2K+",
          label: locale === "es" ? "Familias Apoyadas" : "Families Supported",
          emoji: "🏠",
        },
        {
          number: "100%",
          label: locale === "es" ? "Compromiso" : "Commitment",
          emoji: "💪",
        },
      ],
    },
    {
      ...
      stats: [
        {
          number: "500+",
          label: locale === "es" ? "Jóvenes Becados" : "Scholarship Recipients",
          emoji: "🎓",
        },
        {
          number: "50+",
        ...
        {
          number: "∞",
          label: locale === "es" ? "Esperanza" : "Hope",
          emoji: "💫",
        },
      ],
    },
