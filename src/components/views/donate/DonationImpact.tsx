...
export default function DonationImpact() {
  ...
  const achievements2024 = [
    ...
    {
      metric: '98.5%',
      label: locale === 'es' ? 'Satisfacción Beneficiarios' : 'Beneficiary Satisfaction',
      change: '+2.5%'
    }
  ];
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {area.beneficiaries} / {area.goal} {locale === 'es' ? 'personas' : 'people'}
                  </span>
                </div>
                <Progress value={area.progress} className="h-2" />
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">
                    {area.progress}% {locale === 'es' ? 'completado' : 'completed'}
                  </span>
      ...
      <Card className="bg-gradient-to-r from-primary/5 to-secondary/5">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-foreground">
            {locale === 'es' ? 'Nuestros Logros en 2024' : 'Our 2024 Achievements'}
          </CardTitle>
          <CardDescription>
            {locale === 'es' 
