...
import { CalendarIcon, ArrowRightIcon, UsersIcon } from '@radix-ui/react-icons';
              ...
              <Card key={program.id} className="group hover:shadow-lg transition-all duration-300 overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-border">
                    <div className="text-xs text-muted-foreground">
                      {locale === 'es' ? 'Coordinador:' : 'Manager:'} {program.manager.firstName} {program.manager.lastName}
                    </div>
                    <Link 
